...
# ==============================================================================
                ...
                # ---- start your code ---- #
                new_msg = "(" + from_name + ")"
                new_msg += str(time.strftime('%d.%m.%y,%H:%M', time.localtime()))
                new_msg += " " + msg["message"]
                self.indices[from_name].add_msg_and_index(new_msg)
                ...
                for g in the_guys:
                    ...
                    # IMPLEMENTATION
                    # ---- start your code ---- #
                    self.indices[g].add_msg_and_index(new_msg)
                    mysend(
                        to_sock, json.dumps(
...
# ==============================================================================
                ...
                msg = str(self.group.members) #...needs to use self.group functions to work
...
# ==============================================================================
                ...
                # ---- start your code ---- #
                num = msg["target"]
                poem_list = self.sonnet.get_poem(int(num)) #...needs to use self.sonnet functions to work
                poem = ""
...
# ==============================================================================
                ...
                # ---- start your code ---- #
                from_name = self.logged_sock2name[from_sock]
                rslt_tuplelist = self.indices[from_name].search(msg["target"])
                
                search_rslt = ""
                for i in rslt_tuplelist:
                    search_rslt += i[1]
                    search_rslt += "\n"
